...
.	 *	JwtUtils#generateJwtToken(org.springframework.security.
	...
	void testValidateJwtToken() {
		...
		assertTrue(jwtUtils.validateJwtToken(result).getBody().equals("Validated Successfully...."));
	...
	void testValidateJwtTokenThrowsSignatureException() {
		...
		final ResponseEntity<String> value = jwtUtils.validateJwtToken(token);
		final boolean result = value.getBody().matches("JWT Token is Not Valid.*");
